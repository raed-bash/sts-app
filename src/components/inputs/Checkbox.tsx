    ...
    <div className="w-4 h-4">
      <label
        ...
        className={cn(
          ...
          "aria-checked:before:content-[''] before:absolute aria-checked:before:w-2.5 before:h-[1.5px] before:bg-white aria-checked:before:-rotate-52 before:right-px",
          "aria-checked:after:content-[''] after:absolute aria-checked:after:w-1 after:-translate-x-[3.5px] after:translate-y-[1.6px] after:h-[1.5px] after:bg-white after:rotate-45",
