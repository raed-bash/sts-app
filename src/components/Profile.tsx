...
export default function Profile() {
  ...
  return (
    <div className="relative">
      ...
      {openProfile && (
        <div className="absolute flex gap-8 flex-row justify-center items-center top-full right-0 min-w-[470px] min-h-32 p-4 bg-(--background)  shadow-(--shadow) duration-150 rounded-lg">
          {meQuery.isLoading ? (
            <Loading />
          ) : (
            <>
